...
<p>
	...
	<select name="<?php echo $this->get_field_name('category'); ?>" id="<?php echo $this->get_field_id('category'); ?>">
		...
		<?php print $RECIPESHAREOBJ->listOptions('categories', $category); ?>
	</select>
</p>
<p>
...
<p>
	<input type="checkbox" name="<?php echo $this->get_field_name('submit_link'); ?>" id="<?php echo $this->get_field_id('submit_link'); ?>" />
